...
description: '一份 Git 工具介绍和常用命令手册：覆盖 clone、branch、commit、diff、stash、rebase、cherry-pick、reflog 和团队协作。'
author: 'Reese'
date: '2024-05-12'
topics:
  - cloud-tooling
...
Git 不只是“把代码传上去”。它更重要的作用是让每一次变更都能被理解、回放、定位和撤销。命令很多，但日常主线其实很稳定：看状态、看 diff、分组提交、同步远端、必要时用 reflog 救场。
